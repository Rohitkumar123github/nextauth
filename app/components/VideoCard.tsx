...
export default function VideoCard() {
    return (
        <div className='w-[350px] h-[300px]  flex flex-col justify-center relative mx-auto'>
            <Image src={defaultImage} height={1080} width={1080} alt="image" className='w-[350px] h-[250px] rounded-lg mb-2'/>
            <div className='flex'>
                <div className='mr-3'>
